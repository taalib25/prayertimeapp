...
interface InputWithLabelProps {
    ...
    keyboardType?: any; // React.ComponentProps<typeof TextInput>['keyboardType'];
    editable?: boolean;
    isDate?: boolean;
...
const EditProfileScreen: React.FC = () => {
    ...
    const [profileImage, setProfileImage] = useState('https://example.com/default-profile.jpg');
    ...
    const handleSaveChanges = () => {
        ...
        console.log('Saving changes:', { name, email, mobile, address, birthday, nearestMasjid });
            ...
            <View style={styles.profileHeader}>
                <TouchableOpacity onPress={() => {}}>
                    <View style={styles.profileImageContainer}>
                        <Image
                            source={profileImage ? { uri: profileImage } : require('./assets/default-avatar.png')} // Provide a fallback default avatar
